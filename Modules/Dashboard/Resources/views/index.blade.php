            ...
            <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        ...
                                        <div class="ml-auto">
                                            <div class="report-box__indicator bg-danger tooltip cursor-pointer" title="2% Lower than last month"> 2% <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-span-12 xl:col-span-8 mt-6">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="report-maps mt-5 bg-slate-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="/{{ asset('') }}{{ asset('backend') }}/dist/json/location.json"></div>
                    </div>
                </div>
                <!-- END: Official Store -->
                ...
                <div class="col-span-12 xl:col-span-4 mt-6">
                    ...
                    <div class="mt-5">
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template" src="{{ asset('backend') }}/dist/images/profile-8.jpg">
                                </div>
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template" src="{{ asset('backend') }}/dist/images/profile-11.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template" src="{{ asset('backend') }}/dist/images/profile-7.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                        ...
                        <a href="#" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-slate-400 dark:border-darkmode-300 text-slate-500">View
                            More</a>
                    </div>
                </div>
                ...
                <div class="col-span-12 mt-6">
                    <div class="intro-y block sm:flex items-center h-10">
                        ...
                        <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                            <button class="btn box flex items-center text-slate-600 dark:text-slate-300"> <i data-lucide="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> Export to
                                Excel </button>
                        ...
                        <table class="table table-report sm:mt-2">
                            ...
                            <tbody>
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-3.jpg" title="Uploaded at 10 February 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-9.jpg" title="Uploaded at 27 April 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-4.jpg" title="Uploaded at 15 March 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-success"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> Active
                                        </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="#"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                            </a>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-9.jpg" title="Uploaded at 2 July 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-1.jpg" title="Uploaded at 3 November 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-14.jpg" title="Uploaded at 10 June 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-14.jpg" title="Uploaded at 13 October 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-3.jpg" title="Uploaded at 20 September 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-3.jpg" title="Uploaded at 20 January 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-8.jpg" title="Uploaded at 18 July 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-8.jpg" title="Uploaded at 26 April 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="{{ asset('backend') }}/dist/images/preview-2.jpg" title="Uploaded at 26 December 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">50</td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-danger"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> Inactive
                                        </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                        ...
                        <div class="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                    ...
                                    <div class="text-slate-500">
                                        ...
                                        <div class="flex mt-2">
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Oppo Find X2 Pro">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('backend') }}/dist/images/preview-3.jpg">
                                            </div>
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="{{ asset('backend') }}/dist/images/preview-6.jpg">
                                            </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="{{ asset('backend') }}/dist/images/profile-4.jpg">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
