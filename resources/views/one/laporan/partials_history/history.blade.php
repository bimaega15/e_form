<div class="col-span-12 md:col-span-12 xl:col-span-12 2xl:col-span-12 mt-3 px-10">
    ...
    <div class="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
        ...
        <div class="intro-x relative flex items-center mb-3">
            ...
            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                ...
                @php
                $classButton = '';
                if($setApprove->status_transaction == 'disetujui'){
                $classButton = 'text-success';
                }
                @endphp
                <div class="box px-5 py-3 ml-4 flex-1">
                    <strong class="{{ $classButton }}">{{ $setApprove->keterangan_approvel }}</strong>
                </div>
            </div>
        </div>
        @endforeach
