...
<div class="col-span-12 sm:col-span-12 mb-2">
    <label for="" class="form-label">Diteruskan Oleh</label>
    <select name="users_id_forward" id="" class="form-select select2ServerSide" style="width: 100%;" data-url="{{ route('setting.users.getUsersProfile') }}">
